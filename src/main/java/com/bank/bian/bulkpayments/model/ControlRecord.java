package com.bank.bian.bulkpayments.model;
...
/**
 * The BIAN control record for this service domain: "Bulk Payment File Procedure".
 *
 ...
 * to its asset type (Bulk Payment File). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Bulk Payment File Procedure";
